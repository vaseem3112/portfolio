    ...
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-12 md:flex-row md:items-center md:justify-between md:px-10">
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            href="mailto:vaseemanchuri@gmail.com"
            aria-label="Email"
            className="text-muted transition-colors hover:text-emerald"
          >
            <Mail size={20} />
      ...
      <div className="mx-auto max-w-6xl px-6 pb-8 font-mono text-[11px] text-muted md:px-10">
        © {new Date().getFullYear()} Vaseem Manchuri. Built with{" "}
        <Link href="/" className="underline decoration-border hover:text-emerald">
          Next.js
        </Link>
        .
      </div>
